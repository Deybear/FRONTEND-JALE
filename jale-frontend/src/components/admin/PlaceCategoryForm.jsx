...
function PlaceCategoryForm(props)
{
    ...
    const [data, setData] = useState({
        place_id: type === 'update' ? category.place_id : 0,
    ...
    const handleSubmit = (e) => {
        ...
        if(type === 'create')
        {
            ...
            {
                //* - - - </> [DATA] </> - - - *//
                service.createPlaceCategory(data)
        ...
        else
        {
            ...
            {
                //* - - - </> [DATA] </> - - - *//
                service.updatePlaceCategory(category.id, data);
                props.setTrigger(false);
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className='formulary-smaller'>
            ...
            <div className='formulary-wrapper'>
                ...
                //* - - - </> [VALUE] </> - - - *//
                defaultValue={type === 'update' ? category.place_id : 0}
