...
function PlaceLocationForm(props)
{
    //* - - - </> [DATA] </> - - - *//
    ...
    const [data, setData] = useState({
        place_lat: type === 'update' ? location.place_lat : "",
        place_lon: type === 'update' ? location.place_lon : "",
        place_id: type === 'update' ? location.place_id : 0
    });
    ...
    const handleSubmit = (e) => {
        ...
        if(type === 'create')
        {
            ...
            {
                //* - - - </> [DATA] </> - - - *//
                service.createPlaceLocation(data)
        ...
        else
        {
            ...
            {
                //* - - - </> [DATA] </> - - - *//
                service.updatePlaceLocation(location.id, data);
                props.setTrigger(false);
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className='formulary-small'>
            ...
            <div className='formulary-wrapper'>
                ...
                //* - - - </> [TEXT] </> - - - *//
                placeholder="Place latitude here*"
                
                //* - - - </> [CLASS] </> - - - *//
                className='formulary-input'

                //* - - - </> [VALUE] </> - - - *//
                defaultValue={type === 'update' ? location.place_lat : ''}
            ...
            <div className='formulary-wrapper'>
                ...
                //* - - - </> [TEXT] </> - - - *//
                placeholder="Place longitude here*"
                
                //* - - - </> [CLASS] </> - - - *//
                className='formulary-input'

                //* - - - </> [VALUE] </> - - - *//
                defaultValue={type === 'update' ? location.place_lon : ''}
            ...
            <div className='formulary-wrapper'>
                ...
                //* - - - </> [VALUE] </> - - - *//
                defaultValue={type === 'update' ? location.place_id : 0}
