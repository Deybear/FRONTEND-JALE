...
function PlaceCategoryTable(props)
{
    //* - - - </> [CLICK] </> - - - *//
    ...
    const handleDelete = (id) => {
        ...
        {
            //* - - - </> [DATA] </> - - - *//
            service.deletePlaceCategory(id);
    ...
    return (
        ...
        <div className='admin-table'>
            ...
            {/* - - - </> [DIV] </> - - - */}
            <PopUp id={'place-category-table'} trigger={popup} setTrigger={setPopup} action={type} category={data}/>
...
export default PlaceCategoryTable;